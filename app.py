...
df_reviews= pickle.load(open('./df_reviews.pickle','rb'))
...
with tab1:
    ...
    book_title = st.selectbox('Please choose the book title', df_reviews['title'].sort_values())
    bookid = df_reviews[df_reviews["title"] == str(book_title)]["work_id"].values[0]
